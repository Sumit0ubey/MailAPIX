...
from MailApixAPI.Controller.database import Base
...
class User(Base):
    ...
    revokeToken = Column(String, unique=True, nullable=True)
    ...
    defaultEmailSend = Column(Integer, nullable=False, server_default=text("0"))
    defaultEmailCanSend = Column(Integer, nullable=False, server_default=text("5"))
